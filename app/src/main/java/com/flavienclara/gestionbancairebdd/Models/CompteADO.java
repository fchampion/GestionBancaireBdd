...
public class CompteADO extends SQLiteOpenHelper {
    ...
    private static final String CREATE_BDD = "CREATE TABLE " + TABLE_COMPTE + " (" + COL_ID + " INTEGER PRIMARY KEYAUTOINCREMENT, " + COL_NUMERO + " TEXT NOT NULL, " + COL_MONTANT + "TEXT NOT NULL);";
